...
library(devEMF)
emf(file="Fig3a.emf")
#svg(filename="Fig3a.svg",family="Helvetica")pdf(file="Fig3a.pdf",family="Helvetica")
#pdf(file="Fig3a.pdf",family="Helvetica")
...
emf(file="Fig3b.emf")
#svg(filename="Fig3b.svg",family="Helvetica")
#pdf(file="Fig3b.pdf",family="Helvetica")
...
axis(2)
dev.off()
#embedFonts("Fig3b.pdf")

## Fig4a is from sim167B  (Fig6a in new document)
#setwd("./sim167B")
## investigation of the 1st 1000 cycles of sim168
load("./sim167B/.CheckPoint");
...
emf(file="Fig6a.emf")
#svg(filename="Fig6a.svg",family="Helvetica")
#pdf(file="Fig6a.pdf",family="Helvetica")
og<- par(cex.lab=1.5, cex.axis=1.25)
...
#setwd("../sim168D")
## investigation of the 1st 1000 cycles of sim168
load("./sim168D/.CheckPoint");
# total population and proportion population by subpopulation
t.pop.series <- apply(pop.series,c(1,3),sum,na.rm=T);
fyr=1
lyr=3000
emf(file="Fig6b.emf")
#svg(filename="Fig6b.svg",family="Helvetica")
#pdf(file="Fig6b.pdf",family="Helvetica")
og<- par(cex.lab=1.5, cex.axis=1.25)
matplot(fyr:lyr,log(t.pop.series[fyr:lyr,]),type="l",xlab="Cycle",ylab="log(Pop)",col=subPopTypes, ylim=c(4,10.5) );
...
#setwd("../sim168D_2019")
## investigation of the 1st 1000 cycles of sim168
load("./sim168D_2019_cap1.5/.CheckPoint");
# total population and proportion population by subpopulation
t.pop.series <- apply(pop.series,c(1,3),sum,na.rm=T);
fyr=1
lyr=500
...
emf(file="Fig5.emf")
#svg(filename="Fig5.svg", family="Helvetica")
#pdf(file="Fig5.pdf", family="Helvetica")
op<- par(mar=c(5+2,4+2,4,2)+0.1, cex=1.1)
boxplot(test$sharing.childhood.gamma ~ test$subPop.id, axes=FALSE, ann=FALSE, boxfill="white")
axis(2)
axis(1, labels=FALSE)
box()
...
## investigation of the 1st 1000 cycles of sim168
load("./sim168D_2019_cap1.35/.CheckPoint");
# total population and proportion population by subpopulation
t.pop.series <- apply(pop.series,c(1,3),sum,na.rm=T);
fyr=1
lyr=500
emf(file="Fig7a.emf")
#svg(filename="Fig7a.svg", family="Helvetica")
#pdf(file="Fig7a.pdf", family="Helvetica")
...
## investigation of the 1st 1000 cycles of sim168
load("./sim168D_2019_cap1.25/.CheckPoint");
# total population and proportion population by subpopulation
t.pop.series <- apply(pop.series,c(1,3),sum,na.rm=T);
fyr=1
lyr=500
...
emf(file="Fig7b.emf")
#svg(filename="Fig7b.svg", family="Helvetica")
#pdf(file="Fig7b.pdf", family="Helvetica")
matplot(fyr:lyr,log(t.pop.series[fyr:lyr,]),type="l",xlab="Cycle",ylab="log(Pop)",col=subPopTypes, ylim=c(4,10.5) );
...
## investigation of the 1st 1000 cycles of sim168
load("./sim168D_2019_cap1.30/.CheckPoint");
# total population and proportion population by subpopulation
t.pop.series <- apply(pop.series,c(1,3),sum,na.rm=T);
fyr=1
lyr=1500
