## sim168D_2019.  Redo of sim168B with childhood sharing gamma effect limited to a factor of 1.30
...
Ncycles =  1500;            # number of iterations in this simulation
...
sim.num <- c("Sim 168D_2019_cap1.30")
mute.rate <- .01
