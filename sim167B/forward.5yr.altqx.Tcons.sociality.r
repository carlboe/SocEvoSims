...
## Sim167B Evolution of sociality -- density based on TotConsumption, N
...
## and get some feel for the variation
      ...
      own.id.sg1 <- c(own.id.sg1,newborn.own.id.sg1)  
      ...
      kinship5.id <- f.kinshipid5(gggggmom.id.kin,ggggmom.id.kin, gggmom.id.kin,
                                  ggmom.id.kin, gmom.id.kin, mom.id.kin,own.id.mat);
